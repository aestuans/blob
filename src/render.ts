interface ProgramInfo {
    ...
    uniformLocations: {
        ...
        blobCenters: WebGLUniformLocation[];
        blobCount: WebGLUniformLocation;
    };
    positionBuffer: WebGLBuffer;
}

export class Renderer {
    public readonly MAX_BLOBS = 40;
    public readonly BLOB_RADIUS = 0.02;
    ...
    private setupBuffer(gl: WebGLRenderingContext): WebGLBuffer | null {
